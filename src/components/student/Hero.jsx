    ...
    <div className='flex flex-col items-center justify-center w-full
     ...
     bg-gradient-to-b from-cyan-100/70'>
      <h1 className='md:text-home-heading-large text-home-heading-small relative font-bold 
       text-gray-800 max-w-3xl mx-auto'>Empowering your learning journey. Discover courses,
        track your progress, and <span className='text-blue-600'>achieve your educational goals with ease.</span>
